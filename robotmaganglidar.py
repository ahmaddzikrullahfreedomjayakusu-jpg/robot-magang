#!/usr/bin/env python3
BUILD_ID = "EDGE_BOUNDARY_ONLY_2026_09_07"
import os
import math
import time
import signal
...
# ============================================================
CAM_BODY_WARN_SCALE = 1.18
CAM_BODY_HARD_SCALE = 1.06

CAM_BODY_WARN_MIN_PX = 35
CAM_BODY_HARD_MIN_PX = 55
CAM_BODY_CENTER_STOP_PX = 95
CAM_BODY_SELF_RATIO_IGNORE = 0.55

CAM_BODY_SOFT_STEER = 14.0
CAM_BODY_HARD_STEER = 46.0
CAM_BODY_EMERGENCY_STEER = 62.0
...
def camera_body_guard(
    ...
    if total_left > total_right:
        ...
        # If center dominant, choose side with more free image space
        direction = (
            "LEFT"
            if total_left < total_right
            else "RIGHT"
...
LIDAR_PREWARN_STEER_MIN = 18.0
LIDAR_PREWARN_STEER_MAX = 64.0
...
def render_lidar_map():
    ...
    txt(
        "LEFT/RIGHT MIRROR FIX | SPACE START/STOP",
        224,
        (255, 255, 255),
        0.44,
        1
...
def update_uturn_state(no_safe_path):
    ...
    if _uturn_state == "SPINNING":
        ...
        rpm_left, rpm_right = motor_spin_360_command(
            _uturn_direction
        )
...
def true_dead_end_for_uturn(
    ...
    A true trap requires:
      - final STOP
      - LiDAR scan active
      - LEFT + CENTER + RIGHT all inside safety / hard-risk area
      - OR multiple independent safety systems agree that robot is trapped
    """
    ...
    trapped = (
        final_direction == "STOP" and
        (
            multi_sensor_trap or
            lidar_all_blocked
        )
    )
...
def main():
    ...
    print("LiDAR  : progressive body-clearance guard + corner intelligence")
    print("Orient : LiDAR LEFT/RIGHT MIRROR FIX AKTIF")
